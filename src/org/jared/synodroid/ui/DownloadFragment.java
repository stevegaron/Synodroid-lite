...
import org.jared.synodroid.ui.SynodroidFragment;
import org.jared.synodroid.action.ShowDetailsAction;
import org.jared.synodroid.action.TaskActionMenu;
import org.jared.synodroid.adapter.ActionAdapter;
import org.jared.synodroid.adapter.TaskAdapter;
import org.jared.synodroid.utils.ActionModeHelper;
...
public class DownloadFragment extends SynodroidFragment implements OnCheckedChangeListener{
	...
	public void showDialogToConnect(boolean autoConnectIfOnlyOneServerP, final List<SynoAction> actionQueueP, final boolean automated) {
		...
		boolean autoDetect = false; //preferences.getBoolean(PREFERENCE_AUTO_DSM, true);
