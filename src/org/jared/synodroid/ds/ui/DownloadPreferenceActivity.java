...
import org.jared.synodroid.ds.data.TaskSort;
import org.jared.synodroid.ds.preference.EditTextPreferenceWithValue;
import org.jared.synodroid.ds.preference.ListPreferenceMultiSelectWithValue;
import org.jared.synodroid.ds.preference.ListPreferenceWithValue;
...
import org.jared.synodroid.ds.wizard.ServerWizard;
		        ...
		        if (!logs.equals("")){
					...
					try {
						...
						try {
							...
							emailIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Synodroid Free - Debug log");
